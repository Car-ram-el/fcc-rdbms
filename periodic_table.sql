...
--
-- Name: properties fk_prop_el; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_prop_el FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
